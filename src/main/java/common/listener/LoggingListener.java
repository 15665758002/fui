...
import common.element.highlight.ElementHighlighter;
...
public class LoggingListener extends AbstractWebDriverEventListener {
    ...
    public void beforeClickOn(WebElement element, WebDriver driver) {
        System.out.println("print:click element with " + getLocatorFromElement(element));
